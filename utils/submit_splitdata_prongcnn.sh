...
#SBATCH --output=/cluster/tufts/wongjiradlabnu/twongj01/gen2/photon_analysis/prongCNN/utils/stdout_splitdata_prongcnn_data_sub00.%j.%N.log
#SBATCH --error=/cluster/tufts/wongjiradlabnu/twongj01/gen2/photon_analysis/prongCNN/utils/griderr_splitdata_prongcnn_data_sub00.%j.%N.log
...
apptainer exec --bind ${BINDING} ${container} bash -c "cd ${RUN_DIR} && source run_prongcnn_splitdata.sh"
