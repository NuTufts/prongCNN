...
#SBATCH --output=/cluster/tufts/wongjiradlabnu/twongj01/gen2/photon_analysis/prongCNN/utils/log/stdout_filter_prongcnn_data_sub00.%j.%N.log
#SBATCH --error=/cluster/tufts/wongjiradlabnu/twongj01/gen2/photon_analysis/prongCNN/utils/err/griderr_filter_prongcnn_data_sub00.%j.%N.log
...
RUN_DIR=/cluster/tufts/wongjiradlabnu/twongj01/gen2/photon_analysis/prongCNN/utils/
...
#singularity exec --bind ${BINDING} ${container} bash -c "cd ${RUN_DIR} && source run_prongcnn_filter.sh"
apptainer exec --bind ${BINDING} ${container} bash -c "cd ${RUN_DIR} && source run_prongcnn_filter.sh"
