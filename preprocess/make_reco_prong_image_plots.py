...
#outpdf = matplotlib.backends.backend_pdf.PdfPages("classification_challenge_reco_prong_images.pdf")
#outtxt = open("classification_challenge_reco_prong_classes.txt","w")
outpdf = matplotlib.backends.backend_pdf.PdfPages("classification_challenge_reco_prong_images_noCosmicTest.pdf")
outtxt = open("classification_challenge_reco_prong_classes_noCosmicTest.txt","w")
...
class ProngDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        Class = getClass(arrays["pdg"][0], arrays["purity"][0])
...
#dataset = ProngDataset("prongCNN_reco_images_file_smallSample_wMasks.root", transform)
dataset = ProngDataset("run_prepare_reco_images/prongCNN_reco_images_file_0.root", transform)
