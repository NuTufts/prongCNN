...
class ProngDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        arrays = tree.arrays(["pdg", "completeness", "purity", "run", "subrun", "event",
        ...
        target = [ getClass(arrays["pdg"][0]), arrays["completeness"][0], arrays["purity"][0], arrays["run"][0], arrays["subrun"][0], arrays["event"][0] ]
